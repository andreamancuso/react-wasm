...
"use strict";
var ReactNativePrivateInterface = require("../../ReactPrivate/ReactNativePrivateInterfaceForFabric"),
    React = require("react"),
...
for (pluginName$jscomp$inline_234 in injectedNamesToPlugins$jscomp$inline_232)
    if (injectedNamesToPlugins$jscomp$inline_232.hasOwnProperty(pluginName$jscomp$inline_234)) {
...
function dispatchEvent(target, topLevelType, nativeEvent) {
    ...
    batchedUpdates$1(function () {
        ...
        if (event) {
            ...
            if (hasRethrowError)
                throw (
                    ((event = rethrowError), (hasRethrowError = !1), (rethrowError = null), event)
                );
        }
    });
}
    ...
    switch (workInProgress.tag) {
        ...
        case 19:
            ...
            if (null === oldProps)
                ...
                requiresClone.isBackwards
                    ? ((oldProps.sibling = workInProgress.child), (workInProgress.child = oldProps))
        ...
        case 23:
            return (
                ...
                null !== current && scheduleRetryEffect(workInProgress, current.retryQueue),
                null
            );
        case 24:
            return null;
...
var internals$jscomp$inline_1280 = {
    ...
    findFiberByHostInstance:
        devToolsConfig$jscomp$inline_1055.findFiberByHostInstance || emptyFindFiberByHostInstance,
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
    ...
    if (!hook$jscomp$inline_1281.isDisabled && hook$jscomp$inline_1281.supportsFiber)
        try {
            (rendererID = hook$jscomp$inline_1281.inject(internals$jscomp$inline_1280)),
...
exports.render = function (element, containerTag, callback, concurrentRoot) {
    ...
    root ||
        ...
        (concurrentRoot = new FiberRootNode(containerTag, root, !1, "", onRecoverableError, null)),
