...
for (pluginName$jscomp$inline_255 in injectedNamesToPlugins$jscomp$inline_253)
    if (injectedNamesToPlugins$jscomp$inline_253.hasOwnProperty(pluginName$jscomp$inline_255)) {
        ...
        if (
            ...
            namesToPlugins[pluginName$jscomp$inline_255] !== pluginModule$jscomp$inline_256
        ) {
...
var ReactNativeFiberHostComponent = (function () {
        ...
        _proto.measureLayout = function (relativeToNativeNode, onSuccess, onFail) {
            if ("number" === typeof relativeToNativeNode) var relativeNode = relativeToNativeNode;
                ...
                relativeToNativeNode._nativeTag && (relativeNode = relativeToNativeNode._nativeTag);
            null != relativeNode &&
...
function getNextLanes(root, wipLanes) {
    ...
    return 0 === nextLanes
        ...
        : 0 !== wipLanes &&
            ...
            suspendedLanes >= root || (32 === suspendedLanes && 0 !== (root & 4194176)))
          ? wipLanes
          : nextLanes;
}
                            ...
                            if (!flushPassiveEffects()) {
                                ...
                                6 === exitStatus
                                    ...
                                    : ((workInProgressRootRenderLanes$13.finishedWork =
                                      ...
                                      (workInProgressRootRenderLanes$13.finishedLanes = nextLanes),
                                      commitRoot(
                                          workInProgressRootRenderLanes$13,
...
function createChildReconciler(shouldTrackSideEffects) {
    ...
    function reconcileChildFibersImpl(returnFiber, currentFirstChild, newChild, lanes) {
                    ...
                    a: {
                        ...
                        newChild.type === REACT_FRAGMENT_TYPE
                            ...
                            : ((lanes = createFiberFromTypeAndProps(
                              ...
                              (lanes.ref = coerceRef(returnFiber, currentFirstChild, newChild)),
                              (lanes.return = returnFiber),
                              (returnFiber = lanes));
                    }
        ...
        return ("string" === typeof newChild && "" !== newChild) || "number" === typeof newChild
            ? ((newChild = "" + newChild),
              null !== currentFirstChild && 6 === currentFirstChild.tag
                  ? (deleteRemainingChildren(returnFiber, currentFirstChild.sibling),
                    ...
                    (returnFiber = currentFirstChild))
                  : (deleteRemainingChildren(returnFiber, currentFirstChild),
                    (currentFirstChild = createFiberFromText(newChild, returnFiber.mode, lanes)),
                    (currentFirstChild.return = returnFiber),
                    (returnFiber = currentFirstChild)),
...
function renderWithHooks(current, workInProgress, Component, props, secondArg, nextRenderLanes) {
    ...
    didScheduleRenderPhaseUpdateDuringThisPass &&
        (current = renderWithHooksAgain(workInProgress, Component, props, secondArg));
    ...
    if (null === baseQueue) hook.memoizedState = pendingQueue;
        ...
        do {
            ...
            if (
                ...
                null === newBaseQueueLast
                    ? ((newBaseQueueFirst = newBaseQueueLast = clone), (baseFirst = pendingQueue))
...
function mountClassInstance(workInProgress, ctor, newProps, renderLanes) {
    ...
    "object" === typeof contextType && null !== contextType
        ...
        : ((contextType = isContextProvider(ctor) ? previousContext : contextStackCursor$1.current),
...
function throwException(root, returnFiber, sourceFiber, value, rootRenderLanes) {
    ...
    if (null !== value && "object" === typeof value && "function" === typeof value.then) {
        ...
        if (null !== tag) {
                    ...
                    return (
                        ...
                        value === noopSuspenseyCommitThenable
                            ...
                            : ((returnFiber = tag.updateQueue),
                              ...
                              tag.mode & 1 && attachPingListener(root, value, rootRenderLanes)),
                        !1
                    );
                case 22:
                    if (tag.mode & 1)
            ...
            throw Error(
                "Unexpected Suspense handler tag (" + tag.tag + "). This is a bug in React.",
            );
        }
        if (1 === root.tag)
            return (
    ...
    if (null === workInProgress.stateNode)
        ...
        hasNewLifecycles ||
            ...
            ((oldProps !== nextProps || oldContext !== contextType) &&
                callComponentWillReceiveProps(workInProgress, instance, nextProps, contextType));
        hasForceUpdate = !1;
        ...
        (getDerivedStateFromProps =
            ...
            ((oldProps !== hasNewLifecycles || oldState !== oldContext) &&
                callComponentWillReceiveProps(workInProgress, instance, nextProps, oldContext));
        hasForceUpdate = !1;
            ...
            ? ("function" === typeof getDerivedStateFromProps$jscomp$0 &&
              ...
              (contextType =
                  ...
                  ? (getDerivedStateFromProps ||
                        ...
                        "function" === typeof instance.UNSAFE_componentWillUpdate &&
                            instance.UNSAFE_componentWillUpdate(nextProps, newState, oldContext)),
        ...
        0 === (didSuspend & 1) && workInProgress.child !== progressedPrimaryFragment
            ? ((nextProps = workInProgress.child),
              ...
              workInProgress.mode & 2 &&
                  ...
                  (nextProps.selfBaseDuration = progressedPrimaryFragment.selfBaseDuration),
                  (nextProps.treeBaseDuration = progressedPrimaryFragment.treeBaseDuration)),
              (workInProgress.deletions = null))
            : ((nextProps = createWorkInProgress(progressedPrimaryFragment, primaryChildProps)),
              (nextProps.subtreeFlags = progressedPrimaryFragment.subtreeFlags & 31457280));
        null !== dehydrated
...
function updateDehydratedSuspenseComponent(
    ...
    if (didSuspend) {
        if (workInProgress.flags & 256)
            return (
                ...
                retrySuspenseComponentWithoutHydrating(current, workInProgress, renderLanes, {
                    value: Error(
    ...
    if (didReceiveUpdate || didPrimaryChildrenDefer) {
        ...
        if (null !== didPrimaryChildrenDefer) {
            ...
            nextProps =
                0 !== (nextProps & (didPrimaryChildrenDefer.suspendedLanes | renderLanes))
                    ? 0
                    : nextProps;
...
function bubbleProperties(completedWork) {
    ...
    if (didBailout)
        if (0 !== (completedWork.mode & 2)) {
            ...
            for (treeBaseDuration$66 = completedWork.child; null !== treeBaseDuration$66; )
                (newChildLanes |= treeBaseDuration$66.lanes | treeBaseDuration$66.childLanes),
...
function completeWork(current, workInProgress, renderLanes) {
    ...
    switch (workInProgress.tag) {
            ...
            if (null !== current && null != workInProgress.stateNode)
                ...
                a: for (renderLanes = workInProgress.child; null !== renderLanes; ) {
                    ...
                    for (; null === renderLanes.sibling; ) {
                        if (null === renderLanes.return || renderLanes.return === workInProgress)
                            break a;
        ...
        case 10:
            return (
                popProvider(workInProgress.type._context), bubbleProperties(workInProgress), null
            );
        case 17:
            return (
                isContextProvider(workInProgress.type) && popContext(),
        ...
        case 19:
            ...
            if (null !== type.tail)
                return (
                    ...
                    push(suspenseStackCursor, newProps ? (renderLanes & 1) | 2 : renderLanes & 1),
                    workInProgress
                );
            bubbleProperties(workInProgress);
            return null;
            ...
            null !== hostParent &&
                (hostParentIsContainer
                    ...
                    : ((finishedRoot = hostParent),
                      ...
                      (nearestMountedAncestor = deletedFiber.indexOf(nearestMountedAncestor)),
...
function commitMutationEffectsOnFiber(finishedWork, root) {
    ...
    switch (finishedWork.tag) {
        ...
        case 22:
            ...
            if (
                flags & 8192 &&
                ((root._visibility = viewConfig ? root._visibility & -2 : root._visibility | 1),
                viewConfig &&
        ...
        try {
            ...
            switch (JSCompiler_inline_result.tag) {
                ...
                case 4:
                    ...
                    insertOrAppendPlacementNodeIntoContainer(finishedWork, before$96, parent$95);
                    break;
                default:
                    throw Error(
...
function recursivelyTraversePassiveMountEffects(root, parentFiber) {
    if (parentFiber.subtreeFlags & 10256)
        for (parentFiber = parentFiber.child; null !== parentFiber; )
            commitPassiveMountOnFiber(root, parentFiber), (parentFiber = parentFiber.sibling);
}
...
function handleThrow(root, thrownValue) {
    ...
    root = workInProgress;
    null === root
        ? ((workInProgressRootExitStatus = 1), (workInProgressRootFatalError = thrownValue))
    ...
    if (unitOfWork.flags & 32768)
        a: {
            ...
            do {
                ...
                root = root.return;
                null !== root &&
                    ((root.flags |= 32768), (root.subtreeFlags = 0), (root.deletions = null));
                workInProgress = root;
            } while (null !== root);
            workInProgressRootExitStatus = 6;
            workInProgress = null;
...
function retryTimedOutBoundary(boundaryFiber, retryLane) {
    ...
    null !== boundaryFiber &&
        (markRootUpdated(boundaryFiber, retryLane), ensureRootIsScheduled(boundaryFiber));
}
    ...
    switch (workInProgress.tag) {
        ...
        case 0:
            return (
                ...
                updateFunctionComponent(current, workInProgress, Component, context, renderLanes)
            );
        case 1:
            return (
                (Component = workInProgress.type),
                ...
                (context =
                    workInProgress.elementType === Component
                        ? context
                        : resolveDefaultProps(Component, context)),
                updateClassComponent(current, workInProgress, Component, context, renderLanes)
            );
        case 3:
            pushHostRootContext(workInProgress);
            if (null === current)
            ...
            return (
                ...
                (context =
                    workInProgress.elementType === Component
                        ? context
                        : resolveDefaultProps(Component, context)),
                updateForwardRef(current, workInProgress, Component, context, renderLanes)
            );
        case 7:
            return (
                reconcileChildren(
        ...
        case 14:
            return (
                ...
                updateMemoComponent(current, workInProgress, Component, context, renderLanes)
            );
        case 15:
        ...
        case 17:
            return (
                ...
                finishClassComponent(null, workInProgress, Component, !0, current, renderLanes)
            );
        case 19:
            return updateSuspenseListComponent(current, workInProgress, renderLanes);
        case 22:
...
var internals$jscomp$inline_1389 = {
    ...
    findFiberByHostInstance:
        devToolsConfig$jscomp$inline_1154.findFiberByHostInstance || emptyFindFiberByHostInstance,
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
    ...
    if (!hook$jscomp$inline_1390.isDisabled && hook$jscomp$inline_1390.supportsFiber)
        try {
            (rendererID = hook$jscomp$inline_1390.inject(internals$jscomp$inline_1389)),
