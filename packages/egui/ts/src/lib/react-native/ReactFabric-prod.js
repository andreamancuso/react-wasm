...
export default (ReactNativePrivateInterface) => {
                                ...
                                if (!flushPassiveEffects()) {
                                    ...
                                    6 === exitStatus
                                        ...
                                        : ((workInProgressRootRenderLanes$9.finishedWork =
                                          ...
                                          (workInProgressRootRenderLanes$9.finishedLanes =
                                              nextLanes),
                                          commitRoot(
                                              workInProgressRootRenderLanes$9,
    ...
    obj.getInspectorDataForInstance = getInspectorDataForInstance;
    ...
    obj.render = function (element, containerTag, callback, concurrentRoot) {
