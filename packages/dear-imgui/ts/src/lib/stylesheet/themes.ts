...
export const theme2: ImGuiStyleForPatching = {
    ...
    colors: {
        ...
        [ImGuiCol.TextDisabled]: [theme2Colors.darkGrey, 1],
        [ImGuiCol.WindowBg]: [theme2Colors.black, 1],
        [ImGuiCol.ChildBg]: [theme2Colors.black, 1],
        [ImGuiCol.PopupBg]: [theme2Colors.white, 1],
        [ImGuiCol.Border]: [theme2Colors.darkGrey, 1],
        [ImGuiCol.BorderShadow]: [theme2Colors.black, 1],
        [ImGuiCol.FrameBg]: [theme2Colors.darkerGrey, 1],
        [ImGuiCol.FrameBgHovered]: [theme2Colors.grey, 1], //
        [ImGuiCol.FrameBgActive]: [theme2Colors.darkGrey, 1],
        [ImGuiCol.TitleBg]: [theme2Colors.darkGrey, 1],
        [ImGuiCol.TitleBgActive]: [theme2Colors.grey, 1], //
        [ImGuiCol.TitleBgCollapsed]: [theme2Colors.darkGrey, 1],
        [ImGuiCol.MenuBarBg]: [theme2Colors.darkGrey, 1],
        [ImGuiCol.ScrollbarBg]: [theme2Colors.grey, 1], //
        [ImGuiCol.ScrollbarGrab]: [theme2Colors.grey, 1], //
        [ImGuiCol.ScrollbarGrabHovered]: [theme2Colors.darkGrey, 1],
        [ImGuiCol.ScrollbarGrabActive]: [theme2Colors.black, 1],
        [ImGuiCol.CheckMark]: [theme2Colors.black, 1],
        [ImGuiCol.SliderGrab]: [theme2Colors.grey, 1], //
        [ImGuiCol.SliderGrabActive]: [theme2Colors.darkGrey, 1],
        [ImGuiCol.Button]: [theme2Colors.darkerGrey, 1],
        [ImGuiCol.ButtonHovered]: [theme2Colors.grey, 1], //
        [ImGuiCol.ButtonActive]: [theme2Colors.darkerGrey, 1],
        [ImGuiCol.Header]: [theme2Colors.darkerGrey, 1],
        [ImGuiCol.HeaderHovered]: [theme2Colors.darkerGrey, 1],
        [ImGuiCol.HeaderActive]: [theme2Colors.darkGrey, 1],
        [ImGuiCol.Separator]: [theme2Colors.black, 1],
        [ImGuiCol.SeparatorHovered]: [theme2Colors.darkGrey, 1],
        [ImGuiCol.SeparatorActive]: [theme2Colors.darkGrey, 1],
        [ImGuiCol.ResizeGrip]: [theme2Colors.darkerGrey, 1],
        [ImGuiCol.ResizeGripHovered]: [theme2Colors.darkGrey, 1],
        [ImGuiCol.ResizeGripActive]: [theme2Colors.grey, 1], //
        [ImGuiCol.Tab]: [theme2Colors.darkerGrey, 1],
        [ImGuiCol.TabHovered]: [theme2Colors.grey, 1], //
        [ImGuiCol.TabActive]: [theme2Colors.darkGrey, 1],
        [ImGuiCol.TabUnfocused]: [theme2Colors.darkerGrey, 1],
        [ImGuiCol.TabUnfocusedActive]: [theme2Colors.darkGrey, 1],
        [ImGuiCol.PlotLines]: [theme2Colors.grey, 1], //
        [ImGuiCol.PlotLinesHovered]: [theme2Colors.darkGrey, 1],
        [ImGuiCol.PlotHistogram]: [theme2Colors.grey, 1], //
        [ImGuiCol.PlotHistogramHovered]: [theme2Colors.darkGrey, 1],
        [ImGuiCol.TableHeaderBg]: [theme2Colors.darkerGrey, 1],
        [ImGuiCol.TableBorderStrong]: [theme2Colors.darkGrey, 1],
        [ImGuiCol.TableBorderLight]: [theme2Colors.grey, 1],
        [ImGuiCol.TableRowBg]: [theme2Colors.darkGrey, 1],
        [ImGuiCol.TableRowBgAlt]: [theme2Colors.grey, 1],
        [ImGuiCol.TextSelectedBg]: [theme2Colors.grey, 1], //
        [ImGuiCol.DragDropTarget]: [theme2Colors.grey, 1], //
        [ImGuiCol.NavHighlight]: [theme2Colors.grey, 1], //
        [ImGuiCol.NavWindowingHighlight]: [theme2Colors.grey, 1], //
        [ImGuiCol.NavWindowingDimBg]: [theme2Colors.grey, 1], //
        [ImGuiCol.ModalWindowDimBg]: [theme2Colors.grey, 1], //
    },
};
