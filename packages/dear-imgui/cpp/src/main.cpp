...
class WasmRunner {
    ...
    WasmRunner() = default;
        ...
        std::string getStyle() {
            ...
            style["disabledAlpha"] = m_view->m_widgetStyle.DisabledAlpha;
            style["windowPadding"] = { m_view->m_widgetStyle.WindowPadding.x, m_view->m_widgetStyle.WindowPadding.y };
            style["windowRounding"] = m_view->m_widgetStyle.WindowRounding;
            style["windowBorderSize"] = m_view->m_widgetStyle.WindowBorderSize;
            style["windowMinSize"] = { m_view->m_widgetStyle.WindowMinSize.x, m_view->m_widgetStyle.WindowMinSize.y };
            style["windowTitleAlign"] = { m_view->m_widgetStyle.WindowTitleAlign.x, m_view->m_widgetStyle.WindowTitleAlign.y };
            style["windowMenuButtonPosition"] = m_view->m_widgetStyle.WindowMenuButtonPosition;
            style["childRounding"] = m_view->m_widgetStyle.ChildRounding;
            style["childBorderSize"] = m_view->m_widgetStyle.ChildBorderSize;
            style["popupRounding"] = m_view->m_widgetStyle.PopupRounding;
            style["popupBorderSize"] = m_view->m_widgetStyle.PopupBorderSize;
            style["framePadding"] = { m_view->m_widgetStyle.FramePadding.x, m_view->m_widgetStyle.FramePadding.y };
            style["frameRounding"] = m_view->m_widgetStyle.FrameRounding;
            style["frameBorderSize"] = m_view->m_widgetStyle.FrameBorderSize;
            style["itemSpacing"] = { m_view->m_widgetStyle.ItemSpacing.x, m_view->m_widgetStyle.ItemSpacing.y };
            style["itemInnerSpacing"] = { m_view->m_widgetStyle.ItemInnerSpacing.x, m_view->m_widgetStyle.ItemInnerSpacing.y };
            style["cellPadding"] = { m_view->m_widgetStyle.CellPadding.x, m_view->m_widgetStyle.CellPadding.y };
            style["touchExtraPadding"] = { m_view->m_widgetStyle.TouchExtraPadding.x, m_view->m_widgetStyle.TouchExtraPadding.y };
            style["indentSpacing"] = m_view->m_widgetStyle.IndentSpacing;
            style["columnsMinSpacing"] = m_view->m_widgetStyle.ColumnsMinSpacing;
            style["scrollbarSize"] = m_view->m_widgetStyle.ScrollbarSize;
            style["scrollbarRounding"] = m_view->m_widgetStyle.ScrollbarRounding;
            style["grabMinSize"] = m_view->m_widgetStyle.GrabMinSize;
            style["grabRounding"] = m_view->m_widgetStyle.GrabRounding;
            style["logSliderDeadzone"] = m_view->m_widgetStyle.LogSliderDeadzone;
            style["tabRounding"] = m_view->m_widgetStyle.TabRounding;
            style["tabBorderSize"] = m_view->m_widgetStyle.TabBorderSize;
            style["tabMinWidthForCloseButton"] = m_view->m_widgetStyle.TabMinWidthForCloseButton;
            style["tabBarBorderSize"] = m_view->m_widgetStyle.TabBarBorderSize;
            style["tableAngledHeadersAngle"] = m_view->m_widgetStyle.TableAngledHeadersAngle;
            style["tableAngledHeadersTextAlign"] = { m_view->m_widgetStyle.TableAngledHeadersTextAlign.x, m_view->m_widgetStyle.TableAngledHeadersTextAlign.y };
            style["colorButtonPosition"] = m_view->m_widgetStyle.ColorButtonPosition;
            style["buttonTextAlign"] = { m_view->m_widgetStyle.ButtonTextAlign.x, m_view->m_widgetStyle.ButtonTextAlign.y };
            style["selectableTextAlign"] = { m_view->m_widgetStyle.SelectableTextAlign.x, m_view->m_widgetStyle.SelectableTextAlign.y };
            style["separatorTextPadding"] = { m_view->m_widgetStyle.SeparatorTextPadding.x, m_view->m_widgetStyle.SeparatorTextPadding.y };
            style["displayWindowPadding"] = { m_view->m_widgetStyle.DisplayWindowPadding.x, m_view->m_widgetStyle.DisplayWindowPadding.y };
            style["displaySafeAreaPadding"] = { m_view->m_widgetStyle.DisplaySafeAreaPadding.x, m_view->m_widgetStyle.DisplaySafeAreaPadding.y };
            style["mouseCursorScale"] = m_view->m_widgetStyle.MouseCursorScale;
            style["antiAliasedLines"] = m_view->m_widgetStyle.AntiAliasedLines;
            style["antiAliasedLinesUseTex"] = m_view->m_widgetStyle.AntiAliasedLinesUseTex;
            style["antiAliasedFill"] = m_view->m_widgetStyle.AntiAliasedFill;
            style["curveTessellationTol"] = m_view->m_widgetStyle.CurveTessellationTol;
            style["circleTessellationMaxError"] = m_view->m_widgetStyle.CircleTessellationMaxError;
            
            style["hoverStationaryDelay"] = m_view->m_widgetStyle.HoverStationaryDelay;
            style["hoverDelayShort"] = m_view->m_widgetStyle.HoverDelayShort;
            style["hoverDelayNormal"] = m_view->m_widgetStyle.HoverDelayNormal;

            style["hoverFlagsForTooltipMouse"] = m_view->m_widgetStyle.HoverFlagsForTooltipMouse;
            style["hoverFlagsForTooltipNav"] = m_view->m_widgetStyle.HoverFlagsForTooltipNav;

            style["colors"] = json::array();

            for (int i = 0; i < ImGuiCol_COUNT; i++) {
                style["colors"].push_back(IV4toJsonHEXATuple(m_view->m_widgetStyle.Colors[i]));
            }
